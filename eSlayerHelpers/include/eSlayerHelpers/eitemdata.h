...
struct eItemData {
    ...
    float fValue1Min = 0.f;
    float fValue2Min = 0.f;
    float fValue3Min = 0.f;
    float fValue4Min = 0.f;

    float fValue1Max = 0.f;
    float fValue2Max = 0.f;
    float fValue3Max = 0.f;
    float fValue4Max = 0.f;
